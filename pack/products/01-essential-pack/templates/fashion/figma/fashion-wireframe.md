# Figma Handoff Spec — Fashion

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #be185d · **Accent surface**: #fdf2f8

## Desktop 1440×1024 — `Fashion/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `fashion-landing.html`.
