# Figma Handoff Spec — Lifestyle

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #d97706 · **Accent surface**: #fffbeb

## Desktop 1440×1024 — `Lifestyle/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `lifestyle-landing.html`.
