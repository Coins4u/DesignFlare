# Figma Handoff Spec — Beauty

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #c026d3 · **Accent surface**: #fdf4ff

## Desktop 1440×1024 — `Beauty/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `beauty-landing.html`.
