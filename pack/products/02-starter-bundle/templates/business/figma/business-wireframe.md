# Figma Handoff Spec — Business

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #2563eb · **Accent surface**: #eff6ff

## Desktop 1440×1024 — `Business/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `business-landing.html`.
