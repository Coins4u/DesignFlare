# Figma Handoff Spec — Events

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #e11d48 · **Accent surface**: #fff1f2

## Desktop 1440×1024 — `Events/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `events-landing.html`.
