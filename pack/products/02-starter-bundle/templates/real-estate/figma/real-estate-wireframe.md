# Figma Handoff Spec — Real Estate

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #0f766e · **Accent surface**: #f0fdfa

## Desktop 1440×1024 — `Real Estate/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `real-estate-landing.html`.
