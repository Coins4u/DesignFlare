# Figma Handoff Spec — Photography

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #171717 · **Accent surface**: #f5f5f5

## Desktop 1440×1024 — `Photography/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `photography-landing.html`.
