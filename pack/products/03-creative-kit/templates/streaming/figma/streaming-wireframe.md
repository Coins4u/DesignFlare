# Figma Handoff Spec — Streaming

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #ef4444 · **Accent surface**: #fef2f2

## Desktop 1440×1024 — `Streaming/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `streaming-landing.html`.
