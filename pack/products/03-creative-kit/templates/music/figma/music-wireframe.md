# Figma Handoff Spec — Music

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #9333ea · **Accent surface**: #faf5ff

## Desktop 1440×1024 — `Music/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `music-landing.html`.
