# Figma Handoff Spec — Podcast

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #0891b2 · **Accent surface**: #ecfeff

## Desktop 1440×1024 — `Podcast/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `podcast-landing.html`.
