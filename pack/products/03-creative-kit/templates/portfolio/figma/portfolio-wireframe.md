# Figma Handoff Spec — Portfolio

## Project setup
- **Frame grid**: 8px base · 12-column desktop · 4-column mobile
- **Font**: Inter (400/600/700/800)
- **Primary**: #6366f1 · **Accent surface**: #eef2ff

## Desktop 1440×1024 — `Portfolio/Landing`
| Section | Height | Spec |
|---------|--------|------|
...
## Dev sync
HTML classes prefixed `df-` map 1:1 to this spec. See `portfolio-landing.html`.
