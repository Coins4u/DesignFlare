/**
 * Direct Whop checkout links — DesignFlare checkout invoice emails only.
...
export function getPaymentLinkForTier(tierName) {
  if (typeof tierName !== 'string' || !tierName.trim()) return null;
...
export function buildCustomerInvoiceEmail({ fullName, tierName, price, paymentLink }) {
